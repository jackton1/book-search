  ...
  return (
    <AuthLayout>
      ...
      <form className="flex flex-col space-y-4 bg-gray-50 px-4 py-8 sm:px-16" action={formAction}>
        ...
        />
        <AuthNavigationLink message="Don't have an account?" href="/register" linkText="Sign up"
                            postMessage="for free."/>
        <AuthNavigationLink message="Forgot your password?" href="/change-password" linkText="Reset password"
                            postMessage="."/>
      </form>
    </AuthLayout>
  );
