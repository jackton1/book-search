  ...
  return (
    <AuthLayout>
      ...
      <form className="flex flex-col space-y-4 bg-gray-50 px-4 py-8 sm:px-16" action={formAction}>
        ...
        />
        <Link href="/books" className="flex h-10 w-full items-center justify-center rounded-md border bg-gray-200 text-sm text-black transition-all focus:outline-none">
            No, Stay Here
        </Link>
      </form>
    </AuthLayout>
